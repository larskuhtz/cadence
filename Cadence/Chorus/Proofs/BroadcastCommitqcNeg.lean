...
theorem broadcast_commitqc_neg_commitqc_neg_mvba_pos_excl (ρ : Type) (σ : Type) (slot : Type)
    ...
    [broadcast_commitqc_neg_dec_0 : delta% @Chorus.broadcast_commitqc_neg._veil_dec_type_0 nodeset node nset]
    [broadcast_commitqc_neg_dec_1 :
      delta%
        @Chorus.broadcast_commitqc_neg._veil_dec_type_1 node nodeset χ nset slot merkle_root Phase PathChoice χ_rep] :
    ∀ (j : node) (q : nodeset),
      Veil.VeilM.meetsSpecificationIfSuccessfulAssuming
        (@broadcast_commitqc_neg.ext ρ σ slot slot_dec_eq slot_inhabited node node_dec_eq node_inhabited nodeset
          ...
          χ_rep_lawful σ_sub ρ_sub broadcast_commitqc_neg_dec_0 broadcast_commitqc_neg_dec_1 j q)
  ...
  cases hb : st.mvba_decided_pos J M with
  | false => rfl
  | true =>
    exfalso
    by_cases hnew : j = J
    · subst hnew
      ...
      have ha_fqn := hinv.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.1 a j ha_hon' (hq a (by simpa using ha_mem)).1
      obtain ⟨Qn, hQn_sup, hQn⟩ := hinv.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.1 a j ha_hon' ha_fqn
      rcases hinv.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.1 j M hb with ⟨Q2, hQ2_sup, hQ2⟩ | ⟨-, ⟨qf, hqf_sup, hqf⟩⟩
    ...
    · have hold : st.msg_commitqc_neg J = true := hqcneg hnew
      have hz := hinv.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.2.1 J M hold
